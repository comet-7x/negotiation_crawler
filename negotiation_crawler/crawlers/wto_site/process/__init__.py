...
_CN_NAMES: dict[str, str] = {
    ...
    "impfishag_dgmessage_e.pdf":      "实施指南·总干事致辞",
    "impfishag_part_1_e.pdf":         "实施指南·第1章 导言",
    "impfishag_Part_2_e.pdf":         "实施指南·第2章 协定摘要及对发展中成员的影响",
    "impfishag_Part_3_e.pdf":         "实施指南·第3章 发展融资",
    "impfishag_conclusion_e.pdf":     "实施指南·结论",
    "impfishag_annex_how_to_e.pdf":   "实施指南·附件 如何接受议定书",
    "impfishag_faq_e.pdf":            "常见问题解答（FAQ）",
    "impfishag_model_e.pdf":          "接受书范本",
    "ngr_presentation_on_rfmo_as.pdf": "NGR：RFMO/As 专题演示（2025年5月）",
    "agreement_on_fisheries_subsidies_information_session_22_may_2025_final.pdf":
        "渔业补贴协定信息会议演示（2025年5月）",
